...
struct ContentView: View {
    ...
    func queryAPI() {
        ...
        "https://billboard-api2.p.rapidapi.com/hot-100?date=2021-02-20&range=1-10\(apiKey)"
            ...
            if let data = try? Data(contentsOf: url) {
                ...
                for i in 1...10 {
                    if let item = content[String(i)]?.dictionaryValue {
                        ...
                        let single = Single(rank: rank, title: title, artist:
                                                
                                                artist, lastWeek: lastWeek, peakPosition:
                                                    peakPosition, weeksOnChart: weeksOnChart, detail:
                                                        detail)
